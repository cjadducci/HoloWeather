/* global Log, Class, Loader, Class, Holo */
/* exported Module */
...
var Module = Class.extend({
    ...
    // Set the minimum HoloWeather module version for this module.
    requiresVersion: "0.0.1",
	...
	/* getDom()
	 * This method generates the dom which needs to be displayed. This method is called by the HoloWeather core.
	 * This method can to be subclassed if the module wants to display info on the screen.
	 ...
	 * This method is called by the HoloWeather core, but only if the user has configured a default header for the module.
	 * This method needs to be subclassed if the module wants to display modified headers on the screen.
	 *
	 ...
	 * This method is called by the HoloWeather core.
	 *
    ...
    socket: function () {
        if (typeof this._socket === "undefined") {
            this._socket = this._socket = new HoloSocket(this.name);
        }
	...
	/* loadStyles()
	 * Load all required stylesheets by requesting the Holo object to load the files.
	 *
	...
	/* loadScripts()
	 * Load all required scripts by requesting the Holo object to load the files.
	 *
	 * argument callback function - Function called when done.
	 */
    ...
    sendNotification: function (notification, payload) {
        Holo.sendNotification(notification, payload, this);
    },
    ...
    hide: function (speed, callback, options) {
        ...
        var self = this;
        Holo.hideModule(self, speed, function () {
            self.suspend();
            callback();
        }, options);
    },
    ...
    show: function (speed, callback, options) {
        ...
        this.resume();
        Holo.showModule(this, speed, callback, options);
    }
});
...
Module.register = function (name, moduleDefinition) {
    ...
    if (moduleDefinition.requiresVersion) {
        Log.log("Check HoloWeather version for module '" + name + "' - Minimum version:  " + moduleDefinition.requiresVersion + " - Current version: " + version);
