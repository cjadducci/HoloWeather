...
console.log("Starting HoloWeather: v" + global.version);

// global absolute root path
global.root_path = path.resolve(__dirname + "/../");

if (process.env.HOLO_CONFIG_FILE) {
    global.configuration_file = process.env.HOLO_CONFIG_FILE;
}

//TODO temp fix
if (process.env.HOLO_PORT) {
    global.mmPort = process.env.HOLO_PORT;
}

// The next part is here to prevent a major exception when there
// is no internet connection. This could probably be solved better.
process.on("uncaughtException", function (err) {
    console.log("Whoops! There was an uncaught exception...");
    console.error(err);
    console.log("HoloWeather will not quit, but it might be a good idea to check why this happened. Maybe no internet connection?");
    console.log("If you think this really is an issue, please open an issue on GitHub: https://github.com/cjadducci/HoloWeather/issues");
});
    ...
    var loadModule = function (module, callback) {
        ...
        if (loadModule) {
            ...
            if (m.requiresVersion) {
                console.log("Check HoloWeather version for node helper '" + moduleName + "' - Minimum version:  " + m.requiresVersion + " - Current version: " + global.version);
