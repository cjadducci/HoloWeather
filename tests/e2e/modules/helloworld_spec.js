...
describe("Test helloworld module", function() {
	...
	describe("helloworld set config text", function () {
		before(function() {
			...
			process.env.HOLO_CONFIG_FILE = "tests/configs/modules/helloworld/helloworld.js";
		});
	...
	describe("helloworld default config text", function () {
		before(function() {
			// Set config sample for use in test
            process.env.HOLO_CONFIG_FILE = "tests/configs/modules/helloworld/helloworld_default.js";
		});
