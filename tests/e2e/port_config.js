...
describe("port directive configuration", function () {
	...
	describe("Set port 8090", function () {
		before(function () {
            ...
            process.env.HOLO_CONFIG_FILE = "tests/configs/port_8090.js";
		});
    ...
    describe("Set port 8100 on enviroment variable HOLO_PORT", function () {
		before(function () {
			process.env.HOLO_PORT = 8100;
			// Set config sample for use in this test
            process.env.HOLO_CONFIG_FILE = "tests/configs/port_8090.js";
		});

		after(function () {
            delete process.env.HOLO_PORT;
		});
